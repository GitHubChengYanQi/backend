      ...
      <div class="table-page-search-wrapper">
        <a-form :form="form">
          <a-row :gutter="16">
            ...
            <a-col :lg="4">
              <div class="handle">
                <a-button type="primary" @click="search" v-permission="'/ollowUp/patient2#search'">查询</a-button>
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <div slot="action" class="action" slot-scope="text, record">
            <template>
              <div class="handle">
                <a-button type="primary" ghost @click="detail(record)" v-permission="'/ollowUp/patient2#detail'">详情</a-button>
                <a-dropdown v-permission="'/ollowUp/patient2#update'">
                  <a-menu slot="overlay">
...
export default {
  ...
  methods: {
    ...
    getTableData () {
      ...
      planBindContactList({ isAuth: 2, employeeIds: this.employeeIds, ...this.screenData, categoryIds: this.categoryIds }, params).then((res) => {
        this.loading = false
