    ...
    <div class="leftContainer">
      <div class="leftContainerTop">
        <div class="formDiv">
          ...
          <div class="singleForm">
            <div class="singleFormTitle">SOP名称:</div>
        ...
        <div slot="options" slot-scope="text, record">
          <template>
            <div style="display: flex;justify-content: space-around;">
              <a-button type="link" @click="deleteItem(record.id)" v-permission="'/sopCluster/deleteExecutionLog@delete'">删除</a-button>
            </div>
          </template>
        </div>
      </a-table>
...
export default {
  ...
  methods: {
    ...
    goExportData () {
      ...
      exportClusterSopMethod(params).then(response => {
    ...
    deleteItem (id) {
      ...
      this.$confirm({
        ...
        cancelText: '取消',
        onOk: async () => {
          deleteExecuteRecordSopMethod(params).then(response => {
