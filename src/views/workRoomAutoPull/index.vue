<template>
  <div class="automatic-pulling">
    ...
    <div :split="false" class="lists">
      ...
      <a-alert :show-icon="false" message="1、在本系统添加多个群聊的二维码（群聊数量足够），添加完成后会生成一个渠道活码，一个渠道活码对应一个或多个使用成员（相当于员工）。" banner />
      ...
      <a-alert :show-icon="false" message="在整个流程中，即使在客户不入群或当客户退群时，该客户其实就已添加过员工，可以保持单独联系，完善客户画像，提供一对一的精准服务。" banner />
    </div>
    <a-card>
      <a-row>
        <a-col :span="6">
