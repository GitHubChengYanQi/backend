...
import { bloodSugarTestApi, exportBloodSugarTestApi } from '@/api/healthTest'
  ...
  data () {
    return {
      ...
      tableColumns: [
        ...
        {
          title: '血糖值',
          dataIndex: 'bloodGlucoseVal',
          align: 'center',
          width: 200,
          scopedSlots: { customRender: 'bloodGlucoseVal' }
        },
        {
          title: '采集时段',
          dataIndex: 'samplingPeriodStr',
          align: 'center',
          width: 200,
          scopedSlots: { customRender: 'samplingPeriodStr' }
        },
        {
          title: '数据来源',
