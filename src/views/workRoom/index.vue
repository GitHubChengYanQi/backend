        ...
        <a-card>
          ...
          >
            ...
            <div slot="action" slot-scope="text, record">
              <template>
                <a-button
                  v-permission="'/workRoom/index@member'"
                  type="link"
                  @click="member(record)"
                >群成员</a-button>
                <a-button
    ...
    >
      ...
      >
        ...
        <div slot="otherRooms" slot-scope="text, record">
          <div class="otherRooms" v-for="(item, index) in record.otherRooms" :key="index">{{ item }}</div>
        </div>
      </a-table>
    </a-modal>
...
export default {
  ...
  methods: {
    ...
    async getTableData (page = this.pagination.current) {
      const params = {
        roomGroupId: this.active,
        workRoomName: this.workRoomName,
        workRoomOwnerId: this.employees.join(','),
