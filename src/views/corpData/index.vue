          ...
          <div class="data">
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template #title>企业客户总数</template>
                    <span>总微信客户数</span>
            ...
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template #title>企业群聊总数</template>
                    <span>总微信群数</span>
                    <img :src="require('@/assets/systemHomePage/search-icon.png')" alt />
                  </a-tooltip>
                </div>
            ...
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template #title>企业群聊内客户总数</template>
                    <span>总群成员数</span>
                    <img :src="require('@/assets/systemHomePage/search-icon.png')" alt />
                  </a-tooltip>
                </div>
            ...
            <div>
              ...
              <div class="content">
                ...
                <div>
                  <a-tooltip>
                    <template #title>企业员工总数</template>
                    <span>总企业成员数</span>
                    <img :src="require('@/assets/systemHomePage/search-icon.png')" alt />
                  </a-tooltip>
                </div>
        ...
        <div class="chart-box">
          ...
          <div class="card-box">
            <div class="card-one card-all">
              <div class="card-left">
                <span class="card-title">本月新增好友数</span>
                <span class="card-num">{{ addFriendsNum }}</span>
                <span class="card-add">上月累计新增</span>
            ...
            <div class="card-two card-all">
              <div class="card-left">
                <span class="card-title">本月新增社群数</span>
            ...
            <div class="card-three card-all">
              <div class="card-left">
                <span class="card-title">本月新增群成员</span>
            ...
            <div class="card-four card-all">
              <div class="card-left">
                <span class="card-title">本月流失客户数</span>
